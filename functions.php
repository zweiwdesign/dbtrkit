...
if ( ! function_exists( 'dbtrkit_enqueue_scripts' ) ) :
    ...
    wp_enqueue_style( 'dbtrkit-style', get_template_directory_uri() . '/css/style.css', [], '1.0.48', 'all');

    wp_deregister_style( 'dbtrkit-style-1' );
    wp_enqueue_style( 'dbtrkit-style-1', get_bloginfo('stylesheet_url'), [], '1.0.48', 'all');
